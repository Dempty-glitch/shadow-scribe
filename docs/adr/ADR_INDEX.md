...
> Architecture Decision Records — the "life-or-death" decision map

| ID | Issue | Date | Status | File |
|----|-------|------|--------|------|
| 001 | Watchdog Architecture: Agent-built vs External Agent | 14/04/2026 | 🟢 ACCEPTED | [→](001_watchdog_architecture.md) |
